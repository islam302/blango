...
# Set the environment variable DJANGO_SECRET_KEY instead of hard-coding it here
...
CACHES = {
    'default': {
        ...
        'LOCATION': '127.0.0.1:11211',  # Replace with your Memcached server's IP and port
    }
}
